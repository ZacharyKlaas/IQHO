...
# Version pour l'usage avec ArcMap 9 et avant
# Copier et coller en utilisant le fenêtre "Resultats"
########################################################
...
def montrer():
        ...
        f.create_text(50,140,font="Arial_Black",text=u"Num\u00e9ro de r\u00e8f\u00e8rence:  "+numero_reference+u"-"+assignation_carte,anchor=NW)
        ...
        f.create_text(50,200,font="Arial_Black",text=u"D\u00e9clinaison magn\u00e8tique:  "+declinaison_magnetique,anchor=NW)        
